...
function About({ onHireClick }) {
    return (
        <section
            id="about"
            className="relative z-10 bg-gradient-to-br from-green-100 to-white py-14 sm:py-16 px-4 sm:px-6 lg:px-8"
        >
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-8 sm:gap-10">
                ...
                >
                    <img
                        src={myImage}
                        alt="K Durga Mahesh"
                        className="rounded-2xl shadow-2xl w-60 sm:w-72 md:w-full object-cover"
                    />
                </motion.div>
                ...
                >
                    ...
                    <p className="text-base sm:text-lg text-gray-800 leading-relaxed mb-4 text-justify sm:text-left">
                        Hi, I'm{" "}
